		...
		TabView
		{
			...
			content: Group 
			{
				TextArea
				{
					...
					text: qsTr("Click on the blue help button to learn more about the syntax for order restrictions.")
					width: models.width
	...
	Group
	{
		...
		DropDown
		{
			...
			[
				...
				{ label: qsTr("Unrestricted"), value: "unconstrained" },
	...
	Group
	{
		...
		Group
		{
			...
			CIField
			{
				...
				afterLabel: qsTr("% confidence intervals")
			}
